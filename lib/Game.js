                ...
                if (action === 'Use Potion') {
                    ...
                    inquirer
                        ...
                        .then(({ action }) => {
                            ...
                            console.log(`You used one ${potionDetails[1]} potion!`);
                            console.table(this.player.getStats());
...
Game.prototype.checkEndOfBattle = function() {
    if (this.player.isAlive() && this.currentEnemy.isAlive()) {
        ...
        console.log(`${this.player.name} looted a ${this.currentEnemy.potion.name} potion from the ${this.currentEnemy.name}.`);
